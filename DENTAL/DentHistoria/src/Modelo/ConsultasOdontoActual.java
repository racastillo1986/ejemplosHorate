...
public class ConsultasOdontoActual extends Conexion {
    ...
    public boolean buscar(Odontograma odo) {
        ...
        ResultSet rs = null;
        Connection con = getConexion();
        String sql = "SELECT * FROM odontoactuales WHERE id_pac=?";
