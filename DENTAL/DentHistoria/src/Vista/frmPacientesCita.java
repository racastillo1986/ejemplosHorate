 ...
 * @author Armandfly
 */
public class frmPacientesCita extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Graficos/FondoAzul.png"))); // NOI18N
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        try {
            ...
            if (fsel == -1) {
                ...
                frmCita.txtid_pac.setText(codigo);
                frmCita.txtcedula.setText(cedula);
                frmCita.txtnombre.setText(nombre);
                frmCita.txtapellido.setText(apellido);
                frmCita.txtdireccion.setText(direccion);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPacientesCita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmPacientesCita().setVisible(true);
            }
        });
    }
