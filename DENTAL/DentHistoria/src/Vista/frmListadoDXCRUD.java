 ...
 * @author Armandfly
 */
public class frmListadoDXCRUD extends javax.swing.JFrame {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        try {
            ...
            if (fsel == -1) {
                ...
                m = (DefaultTableModel) frmCDRUDPaciente.jtDx.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmListadoDXCRUD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmListadoDXCRUD().setVisible(true);
            }
        });
    }
