 ...
 * @author Armandfly
 */
public class frmPacientesOdontograma extends javax.swing.JFrame {
     ...
     */
    public frmPacientesOdontograma() {
        initComponents();
        cargardatos("");
    }
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        try {
            ...
            if (fsel == -1) {
                ...
                frmConsultasPaciente.txtid_pac.setText(codigo);
                frmConsultasPaciente.txtcedula.setText(cedula);
                frmConsultasPaciente.txtnombre.setText(nombre);
                frmConsultasPaciente.txtapellido.setText(apellido);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPacientesOdontograma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmPacientesOdontograma().setVisible(true);
            }
        });
    }
